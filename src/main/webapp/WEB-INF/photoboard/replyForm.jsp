...
<div class="container">
  ...
  <form name=form action="/photoboard/reply.do" method=post>
    ...
    <div class="form-group">
      ...
      <input value="${login}" type="text" class="form-control" id="writeName" name="writeName"  readonly />
    </div>
    ...
    <button type="button" onclick="location.href='/photoboard/photomain?requestPage=${reqeustPage}'" class="btn btn-default">취소</button>
