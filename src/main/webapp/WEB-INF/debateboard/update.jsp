<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<div class="container">
  	<h2><button class="btn" onclick="location.href='/index'"><i class="fa fa-home"></i></button>게시글 수정</h2>
   	<form method="post" action="/debateboard/update.do">  
	    ...
	    <div class="form-group">
			...
			<button onclick="location.href='/debateboard/debatemain?requestPage=${requestPage}'">수정취소</button>
		</div>
