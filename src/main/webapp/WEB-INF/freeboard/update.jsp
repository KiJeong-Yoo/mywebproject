...
<div class="container">
	  ...
	  <form method="post" action="/freeboard/update.do">  
	    ...
	    <div class="form-group">
	      ...
	      <textarea class="form-control" id="content" name="content" cols="80%" rows="10" placeholder="글을 입력 하세요">${board.content}</textarea>
	    </div>
	    
	    <div class="form-group">
			<input type="submit" value="글 수정">
			<button onclick="location.href='/freeboard/freemain?requestPage=${requestPage}'">수정취소</button>
		</div>
