...
<div class="container">
	  ...
	  <form name=form action="/freeboard/reply.do" method=post>
	    ...
	    <button type="button" onclick="location.href='/freeboard/freemain?requestPage=${reqeustPage}'" class="btn btn-default">취소</button>
